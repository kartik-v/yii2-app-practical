...
once for all. The second command installs the practical application in a directory named `practical`.
...
3. Open a console terminal, apply migrations with command `/path/to/php-bin/php /path/to/practical/yii migrate`.

4. Set document roots of your web server:

   - for frontend `/path/to/practical/` and using the URL `http://frontend.dev/`
   - for backend `/path/to/practical/backend/web/` and using the URL `http://backend.dev/`
...
5. Prepare project:
   * download repo [yii2-app-practical](https://github.com/yiisoft/yii2-app-practical/archive/master.zip)
   * unzip it
   * go into directory `yii2-app-practical-master/vagrant/config`
