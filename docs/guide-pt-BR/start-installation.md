...
O segundo comando instala o template avançado de projetos no diretório `practical`.
...
4. Configure a raiz dos documentos do seu servidor Web:
    ...
    ```apache
           <VirtualHost *:80>
               ...
               DocumentRoot "/caminho/para/aplicacao-yii/frontend/"
               
               <Directory "/caminho/para/aplicacao-yii/frontend/">
    ...
    ```nginx
           server {
               ...
               root        /caminho/para/aplicacao-yii/frontend/;
               index       index.php;
...
5. Prepare o projeto:
   * faça do download do repositório [yii2-app-practical](https://github.com/yiisoft/yii2-app-practical/archive/master.zip)
   * descompacte o arquivo
   * entre no diretório `yii2-app-practical-master/vagrant/config`
